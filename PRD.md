...
│   │                                                                      │  │
│   │  • Video segments (.ts/.m4s)  → 1 year TTL                         │  │
│   │  • Thumbnails/Images          → 30 days TTL                        │  │
│   │  • Manifests (.m3u8/.mpd)     → 5 seconds TTL                      │  │
│   │                                                                      │  │
│   │  Cache Hit Target: 95%+                                            │  │
│   └─────────────────────────────────────────────────────────────────────┘  │
│                           │                                                │
...
│   │  Genre listings        │ 10 minutes │ On content change             │  │
│   │                                                                      │  │
...
│   │  • Offline content (encrypted downloads)                           │  │
│   │                                                                      │  │
│   └─────────────────────────────────────────────────────────────────────┘  │
│                                                                             │
...
│   │   ├── Content published  → Invalidate catalog, home page           │  │
│   │   ├── Metadata updated   → Invalidate content details              │  │
│   │   ├── Content removed    → Purge all related caches                │  │
│   │   └── Bulk import        → Full cache refresh                      │  │
│   │                                                                      │  │
│   │   Scheduled Invalidation:                                           │  │
│   │   ├── Trending lists     → Every 15 minutes                        │  │
│   │   ├── Recommendations    → Every 1 hour                            │  │
│   │   └── Analytics data     → Every 5 minutes                         │  │
│   │                                                                      │  │
│   │   CDN Purge API:                                                    │  │
│   │   • Single URL purge     → Instant                                 │  │
│   │   • Wildcard purge       → 5-10 seconds                            │  │
│   │   • Full invalidation    → Emergency only                          │  │
│   │                                                                      │  │
│   └─────────────────────────────────────────────────────────────────────┘  │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
